...
def main(cfg):
    ...
    te_config = cfg.model.get('te_config', None)
    ...
    if te_installed and te_config and not te_config['linear_only']:
        warnings.warn('using attn_impl == torch to take care of key_padding_mask with TransformerEngine...')
